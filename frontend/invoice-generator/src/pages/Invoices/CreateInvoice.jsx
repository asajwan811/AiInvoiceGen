      ...
      const generateNewInvoiceNumber = async () => {
        ...
        try {
          ...
          invoices.forEach((inv) => {
            ...
            const newInvoiceNumber = `INV-${(maxNum + 1).toString().padStart(3, "0")}`;
            setFormData((prev) => ({
              ...prev,
    ...
    <form onSubmit={handleSubmit} className="space-y-8 pb-[100vh]">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-red-800">
          {existingInvoice ? "Edit Invoice:" : "Create A New Invoice:"}
        </h2>
                ...
                <tr key={index} className="">
                  <td className="px-2 sm:px-6 py-4">
                    <input
                      ...
                      className="w-full h-10 px-3 py-2 border border-slate-200 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent"
