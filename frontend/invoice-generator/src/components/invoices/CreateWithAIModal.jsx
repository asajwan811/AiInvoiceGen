  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 text-center">
        <div className="fixed inset-0 bg-black/10 bg-opacity-50 transition-opacity" onClick={onClose}>
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
          ...
          <div className="space-y-4">
            <p className="text-sm text-slate-800">
              Paste any text that contains invoice details (like client name, items, quantities, and prices) and the ai will try to create invoice on its own.
            </p>
            <TextareaField 
            name="invoiceText"
