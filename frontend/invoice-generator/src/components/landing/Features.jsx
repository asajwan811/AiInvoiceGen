...
const Features = () => {
  return (
    <section id="features" className="py-20 lg:py-28 bg-red-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-6xl sm:text-5xl font-extrabold text-red-800">Powerful Features to Run Your Business</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {FEATURES.map((feature, index) => (
            <div key={index} className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100">
              ...
              <a href="#" className="inline-flex items-center text-red-900 font-medium mt-4 hover:text-black transition-colors duration-200">
