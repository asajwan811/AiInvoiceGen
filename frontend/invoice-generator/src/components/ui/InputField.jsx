    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          name={name}
          {...props}
          className={`w-full h-10 pr-3 py-2 border border-slate-200 rounded-lg bg-white text-slate-900 placeholder-red-200 focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent ${
            Icon ? "pl-10" : "pl-3"
          }`}
        />
      </div>
